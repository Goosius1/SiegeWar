...
public enum ConfigNodes {
	...
	PEACEFUL_TOWNS_ENABLED(
			...
			"# ",
			"# By activating peacefulness, a town receives immunity from siege attack,",
			"# in exchange for being vulnerable to instant capture via the Subvert command.",
			"# ",
			"# EFFECTS:",
			"# - Town is immune to siege attack (but not to SiegeZone-forced-PVP from nearby sieges).",
			"# - Town can get instantly captured via the Subvert command (see user guide for more details on this).",
	...
	PEACEFUL_TOWNS_CONFIRMATION_REQUIREMENT_DAYS(
			...
			"# It is recommended to be high, to represent a genuine (even if temporary) committment to peacefulness"),
	...
	PEACEFUL_TOWNS_SUBVERT_ENABLED(
			...
			"true",
			"",
			"# If this setting is true, then subversion (instant capture) of peaceful towns is enabled."),
	PEACEFUL_TOWNS_TOWNY_INFLUENCE_RADIUS(
			...
			"# Towny-Influence is generated by all non-peaceful, non-sieged towns. The value is measured in num-townblocks.",
			"# The nation with the highest Towny-Influence can subvert (instantly occupy) the peaceful town, if it wishes to do so."),
	OCCUPIED_TOWNS(
			"occupied_towns",
			"",
			"",
	...
	PUNISH_NON_SIEGE_PARTICIPANTS_IN_SIEGE_ZONE(
			"punish_unofficial_siege_participants",
			"",
			"",
			"",
			"############################################################",
			...
			""),
	ENABLE_SICKNESS(
			"punish_unofficial_siege_participants.enable_sickness",
			"true",
			"",
			"# If true, a player who is in a siege-zone, but is an unofficial-participant in the siege, will receive war sickness",
			"# An unofficial-participant is a player who does not have a military rank, is not allied to either the attacker or the defender, or is in the siegezone of their own occupied town.",
			"# ",
			"# There are two types of war sickness, full and special.",
			"# ",
			"# Full war sickness is given when the unofficial-participant is either in the wilderness of the besieged town.",
			"#   - Effects: Health 1, Nausea V, Poison V, Weakness V, Slowness III, Mining Fatigue III",
			"# Special war sickness is given when the unofficial-participant is in a town, but that town is not besieged.",
			"#   - Effects: Weakness V"),
	SECONDS_BEFORE_SICKNESS(
			"punish_unofficial_siege_participants.seconds_warning",
			"20",
			"",
			"# This is how many seconds a player has to leave the siege zone before he gets war sickness",
			"# If this is set to 0, no warning will be given and the player will receive war sickness instantly, if enabled"
	),
	BEACON_MARKERS(
			"beacon_markers",
			"",
